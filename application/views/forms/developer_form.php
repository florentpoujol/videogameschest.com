...
if (METHOD == "adddeveloper" || CONTROLLER == "adddeveloper") {
	$legend = lang("adddeveloper_form_legend");
}
...
?>
					...
					<br>
					<?php echo form_label(lang("developer_socialnetworks"), "socialnetworks"); ?> <br>
<?php
...
?>
					...
					<?php echo '<input type="url" name="form[data][socialnetworks][urls]['.$array_id.']" id="socialnetworks_url_'.$array_id.'" value="'.$form["data"]["socialnetworks"]["urls"][$array_id].'"> <br> '; ?> 
<?php
endforeach;
