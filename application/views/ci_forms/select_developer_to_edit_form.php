		...
		<div id="select_developer_to_edit_form">
			{{ form_open("admin/editdeveloper", array("class"=>"form-horizontal")) }} 
				<legend>Select developer to edit</legend>

				{{ get_form_errors() }} 

				<div class="control-group">
					<label class="control-label" for="developer_id_select">Select the developer</label> 
					{{ form_dropdown("developer_id_select", get_users_array("dev"), null, 'id="developer_id_select" class="controls"' ) }} 
				</div>
				<div class="control-group">
